...
% 2. 加载之前的4D类型的数据
% [XTRA,YTRA,XVAL,YVAL] = deal(datastra,labeltra,datasval,labelval);
% [XTES,YTES] = deal(datastes,labeltes);
...
% 4. 贝叶斯优化
% 4.1 输入数据集调用
ObjFc = makeObjFcn0(XTRA,YTRA,XVAL,YVAL,XTES,YTES,dataDir);
% 4.2 运行贝叶斯优化
...
formatSpec = ' bestIdx is %d %d\n testErrorSE is %6.2f\n testError95CI is [%6.2f %6.2f]\n Best Accuracy is %5.2f\n';
